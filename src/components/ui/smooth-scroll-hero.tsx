        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              Забронируйте тур сейчас — и уже скоро вы будете стоять на вершине,
              <br className="hidden md:block" />
              глядя на Кавказ с высоты птичьего полёта.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Довольных гостей</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Уникальных маршрутов</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-2xl md:text-3xl font-black text-white mb-1">7 лет</div>
                <div className="text-xs md:text-sm text-gray-300 font-medium">Опыт гида</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-2xl md:text-3xl font-black text-white mb-1">4x4</div>
                <div className="text-xs md:text-sm text-gray-300 font-medium">Комфортные джипы</div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">ПРОФЕССИОНАЛЬНЫЙ ГИД-ЭКСКУРСОВОД</p>
              <div className="flex flex-wrap justify-center items-center gap-4 text-gray-300">
                <span className="text-xs font-semibold">ИНДИВИДУАЛЬНЫЕ ТУРЫ</span>
                <span className="text-xs font-semibold">ГРУППОВЫЕ ЭКСКУРСИИ</span>
                <span className="text-xs font-semibold">БЕЗОПАСНОСТЬ</span>
                <span className="text-xs font-semibold">КАВКАЗ</span>
              </div>
            </div>
          </div>
        </motion.div>

        ...
        <div className="text-center text-white max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8">
            <a
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30 text-white font-medium transition-all duration-300"
            >

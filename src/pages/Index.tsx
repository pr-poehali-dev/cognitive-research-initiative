  ...
  const timelineEntries = [
    {
      ...
      description:
        "Домбай — горный край невероятной красоты в сердце Карачаево-Черкесии. Три ущелья сходятся в природном амфитеатре, обрамлённом пихтовыми лесами и ледниками. Маршрут полностью под вас: удобный темп, интересные вам локации, остановки там, где захочется. Поедем туда, куда не возят группы.",

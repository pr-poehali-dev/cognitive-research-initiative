  ...
  const timelineEntries = [
    {
      id: 1,
      image:
        "https://cdn.poehali.dev/projects/46dd4494-3289-46e0-b512-2259236e3c49/files/5639da56-bc04-4413-811c-63fb1e1564fe.jpg",
    ...
    },
    {
      id: 2,
      image:
        "https://cdn.poehali.dev/projects/46dd4494-3289-46e0-b512-2259236e3c49/files/c67e9125-4c16-4d4b-b9d5-85953a51fa44.jpg",
    ...
    },
    {
      id: 3,
      image:
        "https://cdn.poehali.dev/projects/46dd4494-3289-46e0-b512-2259236e3c49/files/21c6628c-3c86-4e82-9699-cc5be0900a8a.jpg",
          ...
          <div className="container mx-auto px-6 mb-16">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
                Каждый тур — это особый опыт. Выберите формат, который подходит
                именно вам.
              </p>
            </div>
          </div>
